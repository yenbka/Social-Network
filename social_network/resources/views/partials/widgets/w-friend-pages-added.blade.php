...
<ul class="widget w-friend-pages-added notification-list friend-requests">
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar41-sm.jpg')}}" alt="author">
		</div>
	...
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar42-sm.jpg')}}" alt="author">
		</div>
		<div class="notification-event">
	...
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar43-sm.jpg')}}" alt="author">
		</div>
		<div class="notification-event">
	...
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar44-sm.jpg')}}" alt="author">
		</div>
		<div class="notification-event">
	...
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar45-sm.jpg')}}" alt="author">
		</div>
		<div class="notification-event">
	...
	<li class="inline-items">
		<div class="author-thumb">
			<img src="{{asset('images/avatar46-sm.jpg')}}" alt="author">
		</div>
		<div class="notification-event">
